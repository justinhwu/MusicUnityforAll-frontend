...
song1 = Song.find_or_create_by(name: 'Gold', artist: 'Illenium & Excision', genre: 'Bass & Feels', playtime: 291, song_link: 'FcuMd_N7mmA' )
...
song2= Song.find_or_create_by(name: 'I Fall Apart (Slander Remix)', artist: 'Post Malone, Slander', genre: 'Heaven Trap', playtime: 275, song_link: 'rS9t176LxGM')
